...
import { RowActionDropdown } from "../../components/admin/RowActionDropdown"
...
const useApiRowActions = ({
  ...
  const editPath = allowEdit ? `/admin/${params.slug}/${apiPath}/${itemId}` : undefined
  ...
  const ActionDropdown: FC = () => {
    return <RowActionDropdown onCopy={onCopy} onOpen={onOpen} editPath={editPath} />
  }
